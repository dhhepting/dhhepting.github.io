...
onload = function init() {
  ...
  const h = 1.0/numDivisions;

  console.log('numTeapotPatches', numTeapotPatches);
  ...
  const lightPosition = vec4(0.0, 0.0, 20.0, 0.0);
  ...
  gl.uniform4fv(
      gl.getUniformLocation(program, 'ambientProduct'), ambientProduct);
  gl.uniform4fv(
      gl.getUniformLocation(program, 'diffuseProduct'), diffuseProduct);
  gl.uniform4fv(
      gl.getUniformLocation(program, 'specularProduct'), specularProduct);
  gl.uniform4fv(
      gl.getUniformLocation(program, 'lightPosition'), lightPosition);
  gl.uniform1f(
      gl.getUniformLocation(program, 'shininess'), materialShininess);
