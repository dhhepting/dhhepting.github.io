...
const input = document.querySelector("Xpi_input");
...
*/
  ...
  document.getElementById('X').onchange = function( event ) {
    theta[xAxis] = parseFloat(event.target.value);
    console.log(theta);
  };

  document.getElementById('Y').onchange = function( event ) {
    theta[yAxis] = parseFloat(event.target.value);
    console.log(theta);
  };

  document.getElementById('Z').onchange = function( event ) {
    theta[zAxis] = parseFloat(event.target.value);
    console.log(theta);
  };
