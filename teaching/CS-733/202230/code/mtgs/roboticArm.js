...
window.onload = function init () {
  ...
  const ambientProduct = mult(myLight.lightAmbient, myMaterial.materialAmbient)
  const diffuseProduct = mult(myLight.lightDiffuse, myMaterial.materialDiffuse)
  const specularProduct = mult(myLight.lightSpecular, myMaterial.materialSpecular)
