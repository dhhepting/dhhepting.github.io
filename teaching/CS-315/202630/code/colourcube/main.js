...
import { loadShaderSource, createProgram } from './gl-utils.js';
...
// Load both .glsl files in parallel, then link the program.
const [vertexSource, fragmentSource] = await Promise.all([
  loadShaderSource('./shaders/cube.vert.glsl'),
  loadShaderSource('./shaders/cube.frag.glsl'),
]);
