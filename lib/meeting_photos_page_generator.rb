...
#
# Like the main meeting page (also fully generated now), this file has NO
# hand-authored content at all — it's purely generated from media.csv — so
# it's always safe to overwrite in full, every run, no drift-detection
# needed. Kept a SEPARATE page so re-pasting photos into Moodle never
# disturbs the main page students may be collaboratively editing.
#
